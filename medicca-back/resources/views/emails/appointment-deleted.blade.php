...
<head>
    ...
    <title>Sua consulta foi desmarcada!</title>
    <style>
        body {
...
<body>
    <div class="container">
        <h1>Sua consulta foi desmarcada!</h1>
        <p>Esse email confirma que sua consulta foi desmarcada. Confira os detalhes abaixo:</p>
